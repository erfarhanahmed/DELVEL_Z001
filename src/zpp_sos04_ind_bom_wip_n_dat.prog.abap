...
PARAMETERS p_folder LIKE rlgrap-filename DEFAULT  '/Delval/India'."India'."temp'  "'e:/delval/temp_'   "'e:/delval/temp'.  "H:/planning/actuator'  ##NO_TEXT
.
...
*    INTO lv_fullfile.
  ...
  IF sy-subrc = 0.
DATA lv_string_1094 TYPE string.
DATA lv_crlf_1094 TYPE string.
lv_crlf_1094 = cl_abap_char_utilities=>cr_lf.
lv_string_1094 = hd_csv.
LOOP AT it_csv INTO wa_csv.
CONCATENATE lv_string_1094 lv_crlf_1094 wa_csv INTO lv_string_1094.
  CLEAR: wa_csv.
ENDLOOP.
*TRANSFER lv_string_1922 TO lv_fullfile.
*TRANSFER lv_string_1019 TO lv_fullfile.
TRANSFER lv_string_1094 TO lv_fullfile.
