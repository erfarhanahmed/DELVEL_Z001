...
*MESSAGE 'This Tcode is discontinued. Kindly use ZSOS_DATE_CHNG Tcode' TYPE 'A'.
MESSAGE 'This Tcode is discontinued. Kindly use ZSOS_PRIMUS_NEW Tcode' TYPE 'A'.
...
PARAMETERS p_folder LIKE rlgrap-filename DEFAULT   '/Delval/India'."India'."temp'.              "'e:/delval/temp'.  "H:/planning/actuator'  ##NO_TEXT
.
...
*  lv_file = 'SOSTEST.TXT'.
  ...
  IF sy-subrc = 0.
DATA lv_string_1068 TYPE string.
DATA lv_crlf_1068 TYPE string.
lv_crlf_1068 = cl_abap_char_utilities=>cr_lf.
lv_string_1068 = hd_csv.
LOOP AT it_csv INTO wa_csv.
CONCATENATE lv_string_1068 lv_crlf_1068 wa_csv INTO lv_string_1068.
  CLEAR: wa_csv.
ENDLOOP.
*TRANSFER lv_string_1922 TO lv_fullfile.
TRANSFER lv_string_1068 TO lv_fullfile.
