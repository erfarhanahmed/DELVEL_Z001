...
*  lv_file = 'SOSTEST.TXT'.
  ...
  IF sy-subrc = 0.
DATA lv_string_1003 TYPE string.
DATA lv_crlf_1003 TYPE string.
lv_crlf_1003 = cl_abap_char_utilities=>cr_lf.
lv_string_1003 = hd_csv.
LOOP AT it_csv INTO wa_csv.
CONCATENATE lv_string_1003 lv_crlf_1003 wa_csv INTO lv_string_1003.
  CLEAR: wa_csv.
ENDLOOP.
TRANSFER lv_string_1003 TO lv_fullfile.
