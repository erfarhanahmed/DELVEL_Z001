CLASS ZCL_REWORK_AGEING_REPORT DEFINITION
  PUBLIC FINAL CREATE PUBLIC.
  PUBLIC SECTION.
    INTERFACES IF_AMDP_MARKER_HDB.
    CLASS-METHODS GET_DATA FOR TABLE FUNCTION ZREWORK_AGEING_TF_INVAGEDET.
ENDCLASS.

CLASS ZCL_REWORK_AGEING_REPORT IMPLEMENTATION.
  METHOD GET_DATA
