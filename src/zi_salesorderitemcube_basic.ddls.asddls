@AbapCatalog.sqlViewName: 'ZV_SALES_BASIC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'Basic view for SALES ORDERITEM CUBE'
...
define view ZI_SALESORDERITEMCUBE_BASIC
 with parameters
...
where ( OpenReqdDelivQtyInBaseUnit > 0 )
  or
  ( ItemIsDeliveryRelevant = ''
    and OverallOrdReltdBillgStatus <> 'C')
  and OpenReqdDelivQtyInBaseUnit > 0
  and not (
