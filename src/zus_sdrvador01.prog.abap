...
*&
*&---------------------------------------------------------------------*
REPORT ZUS_SDRVADOR01 LINE-COUNT 100 MESSAGE-ID vn.
...
data :tvbdpa type ZTT_VBDPA.


*data : it_vbdpa type STANDARD TABLE OF tvbdpa.
...
*      lv_control_params TYPE sfpcontrol,
 ...
 DATA: gv_fm_name         TYPE rs38l_fnam.
  CONSTANTS : sf_name1 TYPE fpname VALUE 'ZUS_SD_SALESORDER'.

   gv_form_name = 'ZUS_SD_SALESORDER'.
...
*  CALL FUNCTION gv_fm_name                   "'/1BCDWB/SM00000111'
*    EXPORTING
**     /1BCDWB/DOCPARAMS        =
*      is_addres                = addr_key
*      is_nast                  = nast
