*&---------------------------------------------------------------------*
*& Report ZSD_COMMERCIAL_INVOICE_SFP_DRV
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT zsd_saudi_comm_inv_drv1.
...
CALL FUNCTION l_fmname " '/1BCDWB/SM00000084'
  EXPORTING
*   /1BCDWB/DOCPARAMS        =
...
*
*CALL FUNCTION   l_fmname"'/1BCDWB/SM00000046'
*  EXPORTING
**   /1BCDWB/DOCPARAMS        =
