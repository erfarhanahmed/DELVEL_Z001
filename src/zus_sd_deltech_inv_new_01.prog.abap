...
REPORT zus_sd_deltech_inv_new_01.

* declaration of data
INCLUDE ZRLB_INVOICE_DATA_DECLARE01.
*INCLUDE rlb_invoice_data_declare.
* definition of forms
INCLUDE ZRLB_INVOICE_FORM001.
*INCLUDE rlb_invoice_form01.
INCLUDE ZRLB_PRINT_FORMS01.
...
* END: Country specific extension for Hungary
  ...
  if ( ( xscreen is initial ) and ( nast-tdarmod > 1 ) ).
INCLUDE ZDOCUMENT_OUTPUT_ARCHIVE_OBJ.
...
CALL FUNCTION E_FUNCNM  " '/1BCDWB/SM00000152'
  EXPORTING
*   /1BCDWB/DOCPARAMS        =
